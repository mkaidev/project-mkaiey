...
const ShareModalContent: React.FC<ShareModalContentProps> = ({
  ...
  const urlPrefix = "https://mkaidev-pro.vercel.app/product/";
  ...
  return (
    <div>
      ...
      />
      <div className="py-4">
        <h1 className="text-2xl font-semibold">Share this project</h1>
        <p className="text-gray-600">
          Stay connect by following the project on social media
        </p>
