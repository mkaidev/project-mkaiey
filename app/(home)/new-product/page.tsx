        ...
        <>
          <div className="flex items-center gap-4 mx-auto">
            ...
            <div className="text-md font-semibold">
              Please enter at least 4 characters for the project name.
            </div>
          </div>
        </>,
        {
      ...
      toast(
        <>
          <div className="flex items-center gap-4 mx-auto">
            <PiXCircleFill className="text-red-500 text-3xl" />
            <div className="text-md font-semibold">
              Please select at least 3 categories for the project.
            </div>
          </div>
        </>,
        {
      ...
      <div className="px-8 md:w-3/5 md:mx-auto">
        ...
        {step === 2 && (
          ...
          >
            <h1 className="text-4xl font-semibold">
              📊 What category does your project ?
            </h1>
            <p className="text-xl font-light mt-4 leading-8">
                      ...
                      className={`text-xs md:text-sm p-2 cursor-pointer w-full text-center
                        ${
                          selectedCategories.includes(category)
                            ? "bg-[#38d7ff] text-white rounded-full"
                            : "text-black"
                        }`}
                    >
                      {category}
          ...
          >
            ...
            <div className="mt-4">
              <div className="font-medium">
                Project images ( upload atleast 3 images )
              </div>
        ...
        {step === 5 && (
          ...
          >
            ...
            <p className="text-xl font-light mt-4 leading-8">
              When will your project be available to the public? Select a date
              to continue.
            </p>
        ...
        {step === 6 && (
          ...
          >
            ...
            <p className="text-xl font-light mt-4 leading-8">
              Add links to your project&apos;s website, social media, and other
              platforms
            </p>
        ...
        {step === 7 && (
          ...
          >
            ...
            <p className="text-xl font-light mt-4 leading-8">
              ...
              Your project will be reviewed by our team before it goes live.
            </p>
            ...
            <div className="mt-10 grid grid-cols-2 gap-8">
              ...
              <div className="cols-span-2">
                <div className="font-semibold">Project images</div>
        ...
        {step === 8 && (
          <div className="space-y-10">
            ...
            <div className="text-xl font-light mt-4 leading-8 ">
              Your project has been successfully submitted. Our team will review
            ...
            <div className="flex flex-col  gap-4">
              <div
                ...
                className="bg-[#38d7ff] text-white py-2 px-4
              ...
              <div
                ...
                className="text-[#38d7ff] py-2 px-4 rounded mt-4 
              ...
              <div className="flex items-center">
                {step === 7 ? (
                  <button
                    ...
                    className="bg-[#38d7ff] text-white py-2 px-4 rounded-md mt-4 items-end"
                  >
                    Submit
                  </button>
                ) : (
