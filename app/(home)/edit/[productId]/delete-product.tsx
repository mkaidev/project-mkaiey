    ...
    justify-center rounded-md items-center flex"
      ...
      >
        <div>
          ...
          />
          <h1 className="text-xl font-semibold mb-10">Delete Project</h1>

          <p className="text-sm">
            We&apos;re sorry to see you go. Once your project is deleted, all of
            your content will be permanently gone, including your projects and
            project settings.
          </p>

          <p className="text-sm py-10">
            This action cannot be undone. This will permanently delete your
            project and all of your content.
          </p>
