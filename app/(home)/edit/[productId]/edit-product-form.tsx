    ...
    <div className="h-full">
      ...
      <div className="w-full rounded-md p-10 bg-emerald-100 mt-10 md:flex items-center gap-x-4">
        ...
        <div className="text-gray-600">
          This is the project form. You can update the project details here. If
          your project is currently live, and you make changes to the project
          details. It will delist the project from the marketplace until it is
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-10">
        ...
        <div className="col-span-2">
          <div className="font-medium mb-2">Project Images</div>
